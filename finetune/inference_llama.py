"""
Llama Fine-tuned Model Test Inference Script (vLLM-based)
Usage:
    python test_llama.py \
        --model_path /data/kude/models/llama_b \
...
def main():
    ...
    # Automatically apply Llama3.1 chat format via apply_chat_template
    prompts = []
    for rec in records:
